...
char serviceLongName[] = "UAGCore world service";
char serviceDescription[] = "UAGCore World of Warcraft emulator world service";
/*
...
extern int main(int argc, char** argv)
{
	...
	TC_LOG_INFO("server.worldserver", "Developers: Jobtq");
	TC_LOG_INFO("server.worldserver", "Skype: garden531");
	TC_LOG_INFO("server.worldserver", "Core: Private");
